...
impl TranscriptionPersistence {
    ...
    pub fn save_database(
        ...
        println!(
            "💾 Saved transcription database with {} records",
    ...
    pub fn add_transcription(
        ...
        self.add_transcription_with_raw(
            database, text, None, audio_data, model_used, language, metadata,
        )
    }

    pub fn add_transcription_with_raw(
        &self,
        database: &mut TranscriptionDatabase,
        text: String,
    ...
    pub fn get_transcription<'a>(
        &self,
        database: &'a TranscriptionDatabase,
        id: &str,
    ) -> Option<&'a TranscriptionRecord> {
        database.records.get(id)
    }

    pub fn list_transcriptions<'a>(
        &self,
        database: &'a TranscriptionDatabase,
